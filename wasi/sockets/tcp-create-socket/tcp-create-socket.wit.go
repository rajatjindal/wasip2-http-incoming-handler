...
import (
	...
	"github.com/rajatjindal/wasip2-http-incoming-handler/wasi/sockets/tcp"
...
//go:noescape
func wasmimport_CreateTCPSocket(addressFamily network.IPAddressFamily, result *cm.OKResult[tcp.TCPSocket, network.ErrorCode])
