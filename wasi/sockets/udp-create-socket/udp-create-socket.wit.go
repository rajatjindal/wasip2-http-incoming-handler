...
import (
	...
	"github.com/rajatjindal/wasip2-http-incoming-handler/wasi/sockets/udp"
...
//go:noescape
func wasmimport_CreateUDPSocket(addressFamily network.IPAddressFamily, result *cm.OKResult[udp.UDPSocket, network.ErrorCode])
